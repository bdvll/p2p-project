...
public class ScenarioSetup {
    ...
    public static final KAddress statServer;
    ...
    static {
        try {
            ...
            statServer = NatAwareAddressImpl.open(new BasicAddress(InetAddress.getByName("193.1.1.1"), appPort, new IntIdentifier(1)));
